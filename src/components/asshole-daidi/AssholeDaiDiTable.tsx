                        ...
                        return (
                          <>
                            {dropTargetIndex === i && !isDragging && (
                              <div
                                key={`placeholder-${i}`}
                                className="w-9 h-13 rounded-lg border-2 border-dashed border-primary bg-primary/10 flex items-center justify-center shrink-0"
                              >
                                <span className="text-[8px] text-primary">Drop</span>
                              </div>
                            )}
